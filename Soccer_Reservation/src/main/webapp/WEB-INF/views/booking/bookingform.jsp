		...
		<table class="table">
			...
			<tr>
				...
				<td>
					...
					<input type="text" name="addr1" id="addr1" class="postcodify_address" /><br/>  
					<input type="text" name="addr2" id="addr2" class="postcodify_details"/><br/>
					<input type="text" name="addr3" id="addr3" class="postcodify_extra_info"/><br/> 
